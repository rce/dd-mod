...
{
	class UParticleSystemComponent*                    myLazer;                                                  // 0x0000(0x0004)
	class UParticleSystemComponent*                    myStartEffect;                                            // 0x0004(0x0004)
	struct FVector                                     prevLazerLoc;                                             // 0x0008(0x000C)
	struct FVector                                     currentTargetLoc;                                         // 0x0014(0x000C)
	TArray<struct FDmgActors>                          bellyDmgActors;                                           // 0x0020(0x000C)
	...
	struct FName                                       attachSocket;                                             // 0x0038(0x0008)
};
...
{
	class ADunDef_DamagingInterpActor*                 theCollision;                                             // 0x0000(0x0004)
	struct FName                                       BaseSocketName;                                           // 0x0004(0x0008)
};
...
struct FCrystals
{
	class ADunDef_OldOneCrystals*                      theCrystal;                                               // 0x0000(0x0004)
	struct FName                                       destroyedAnim;                                            // 0x0004(0x0008)
	struct FName                                       crystalTag;                                               // 0x000C(0x0008)
};
...
struct FSmashAnims
{
	struct FName                                       AttackAnimName;                                           // 0x0000(0x0008)
	float                                              MaxDistance;                                              // 0x0008(0x0004)
	float                                              MaxAngle;                                                 // 0x000C(0x0004)
	unsigned long                                      bToggleCollisions : 1;                                    // 0x0010(0x0004)
	TArray<class ADunDef_DamagingInterpActor*>         damageableCollisions;                                     // 0x0014(0x000C)
};
...
struct FHoldAI
{
	class ADunDefEnemy*                                HoldEnemyTemplate;                                        // 0x0000(0x0004)
	struct FName                                       HoldSocketName;                                           // 0x0004(0x0008)
...
{
	float                                              MinimumWaveDifficultyOffset;                              // 0x0000(0x0004)
	float                                              PawnDifficultyOffset;                                     // 0x0004(0x0004)
};
